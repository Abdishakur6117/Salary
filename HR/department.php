...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <!-- User Modal -->
            ...
            <div class="modal fade" id="departmentModal" tabindex="-1" role="dialog" aria-labelledby="userModalLabel" aria-hidden="true">
          ...
          <!-- insert/.modal -->
           <!--  update modal-->
            <div class="modal fade" id="edit_departmentModal" tabindex="-1" role="dialog" aria-labelledby="userModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="userModalLabel">Update  Department</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
                          <div class="modal-body">
                                        <form id="edit_departmentForm" method="POST" action="" >
                                          <div class="row">
                                            <div class="col-md-6">
                                              <div class="form-group">
                                                <label for="department">Department Name </label>
...
<script src="../dist/js/pages/dashboard.js"></script>
  ...
  $(document).ready(function() {
    ...
    $('#departmentForm').submit(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: 'departmentOperation.php?action=create_department',
            data: $(this).serialize(),
            dataType: "json",
    ...
    $(document).on('click', '.editBtn', function() {
        ...
        $('#edit_id').val(departmentData.id);
        $('#edit_department_name').val(departmentData.name);
        $('#edit_description').val(departmentData.description);
        
        $('#edit_departmentModal').modal('show');
    });
    // Update this part in your JavaScript
    $('#edit_departmentForm').submit(function(e) {
        e.preventDefault();
        ...
        $.ajax({
            url: 'departmentOperation.php?action=update_department',
            method: 'POST',
            data: formData,
            dataType: 'json',
            success: function(response) {
                if(response.status === 'success') {
                    showSuccess(response.message, function() {
                        $('#edit_departmentModal').modal('hide');
                        displayData();
                    });
                } else {
    ...
    $(document).on('click', '.deleteBtn', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: 'POST',
                    url: 'departmentOperation.php?action=delete_department',
    ...
    function displayData() {
        $.ajax({
            url: 'departmentOperation.php?action=display_department',
            dataType: 'json',
