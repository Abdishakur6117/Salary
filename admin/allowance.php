...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <!-- User Modal -->
            ...
            <div class="modal fade" id="allowanceModal" tabindex="-1" role="dialog" aria-labelledby="userModalLabel" aria-hidden="true">
                    ...
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                          ...
                          <div class="modal-body">
                                        <form id="allowanceForm" method="POST" action="" >
                                          <div class="row">
                                            <div class="col-md-6">
          ...
          <!-- insert/.modal -->
           <!--  update modal-->
            <div class="modal fade" id="edit_allowanceModal" tabindex="-1" role="dialog" aria-labelledby="userModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="userModalLabel">Update  Allowance</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
                          <div class="modal-body">
                                        <form id="edit_allowanceForm" method="POST" action="" >
                                          <div class="row">
                                            <div class="col-md-6">
                                              <div class="form-group">
                                                <label for="employee">Employee Name </label>
...
<script src="../dist/js/pages/dashboard.js"></script>
  ...
  <script>
    ...
    function loadEmployee() {
        $.ajax({
            url: 'attendanceOperation.php?action=get_employee',
            method: 'GET',
            dataType: 'json',
    ...
    $('#allowanceForm').submit(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: 'allowanceOperation.php?action=create_allowance',
            data: $(this).serialize(),
            dataType: "json",
    ...
    $('#edit_allowanceForm').submit(function(e) {
        e.preventDefault();
        ...
        $.ajax({
            url: 'allowanceOperation.php?action=update_allowance',
            method: 'POST',
            data: formData,
            dataType: 'json',
            success: function(response) {
            ...
            complete: function() {
                submitBtn.prop('disabled', false).html('Update Allowance');
            }
        });
    });
    ...
    $(document).on('click', '.deleteBtn', function() {
        const allowance_id = $(this).data('id');
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: 'POST',
                    url: 'allowanceOperation.php?action=delete_allowance',
    ...
    function displayData() {
        $.ajax({
            url: 'allowanceOperation.php?action=display_allowance',
            dataType: 'json',
